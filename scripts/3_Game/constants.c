...
{
	const string images[] = {
		"Colorful-UI/gui/textures/loading_screens/LoadingScreen_1.edds", 
		"Colorful-UI/gui/textures/loading_screens/LoadingScreen_2.edds",
        "Colorful-UI/gui/textures/loading_screens/LoadingScreen_3.edds",
		"Colorful-UI/gui/textures/loading_screens/LoadingScreen_4.edds",
		"Colorful-UI/gui/textures/loading_screens/LoadingScreen_5.edds",
		"Colorful-UI/gui/textures/loading_screens/LoadingScreen_6.edds",
		"Colorful-UI/gui/textures/loading_screens/LoadingScreen_7.edds",
		"Colorful-UI/gui/textures/loading_screens/LoadingScreen_8.edds",
		"Colorful-UI/gui/textures/loading_screens/LoadingScreen_9.edds"
	};
	Math.Randomize(-1);
...
class MenuURLS {
	// Link for Discord
	static string urlDiscord  = "https://discord.gg/wkFdVTDrU7";
	// Link for Facebook
...
class UIColor
{
	...
	static int Orange() 			  { return ARGB(255, 215, 153, 25); };
