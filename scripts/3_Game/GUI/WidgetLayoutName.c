modded class WidgetLayoutName extends WidgetLayoutName
{
	...
	const string HandsHeader					= "Colorful-UI/gui/layouts/inventory_new/hands_header.layout";
	...
	const string AttachmentsGroupContainer		= "Colorful-UI/gui/layouts/inventory_new/attachments_group_container.layout";
};
