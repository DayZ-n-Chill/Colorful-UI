modded class TabberUI extends ScriptedWidgetEventHandler
{
	...
	int AddTab( string name )
	{
		...
		Widget control = GetGame().GetWorkspace().CreateWidgets( "Colorful-UI/gui/layouts/new_ui/tabber_prefab/colorful.tab_control.layout", m_Root.FindAnyWidget( "Tab_Control_Container" ) );
